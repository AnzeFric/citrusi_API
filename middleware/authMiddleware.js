...
const authMiddleware = (req, res, next) => {
  ...
  if (
    ...
    req.path === "/users/loginMobile" ||
    req.path === "/routes/list" ||
    req.path.startsWith("/users/loginDesktop") ||
    req.path === "/users/logout" ||
    req.path === "/routes/list-paginated" ||
    req.path === "/routes/in-proximity" ||
    req.path.startsWith("/uploads/") ||
    req.path.startsWith("/notifications/") ||
    req.path.startsWith("/users/stats") ||
    req.path.startsWith("/users/friends") ||
    req.path.startsWith("/users/add-friend") ||
    req.path.startsWith("/users/confirm2fa") ||
